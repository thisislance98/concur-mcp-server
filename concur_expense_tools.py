    ...
    return {
        ...
        "how_to": {
            "steps": [
                ...
                {
                    "step": 3,
                    "title": "List expenses (v4)",
                    "description": "Complete example: List expenses for a report",
